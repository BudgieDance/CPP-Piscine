...
int main(){
    ...
    std::cout <<  std::endl  << std::endl << "-------SUPERTRAAAAAP!!!-------" << std::endl;
    SuperTrap super("Donald");

    std::cout << std::endl << "<Checking melee and ranged attacks>" << std::endl; 
    super.meleeAttack("target1");
    ...
    super.takeDamage(90);
    super.takeDamage(42);
    super.beRepaired(188);

    std::cout << std::endl << "<SPECIAL ATTACK TIME!!!>" << std::endl; 
    super.vaulthunter_dot_exe("Target1");
    super.vaulthunter_dot_exe("Target1");

    std::cout << std::endl << "<SUPER SHOEBOX TIME!!!>" << std::endl; 
    super.ninjaShoebox(trap1);
    super.ninjaShoebox(trap3);
